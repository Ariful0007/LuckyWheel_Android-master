...
public class NewRegistration extends AppCompatActivity {
    private EditText edtname, edtemail, edtpass, edtcnfpass, edtnumber,username,emailaddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session =new UserSession(NewRegistration.this);
        firebaseAuth = FirebaseAuth.getInstance();
        new CheckInternetConnection(this).checkConnection();
        progressDialog=KProgressHUD.create(NewRegistration.this);
        emailaddress=findViewById(R.id.emailaddress);
        FirebaseApp.initializeApp(NewRegistration.this);
       ...
       // edtname = findViewById(R.id.phonr);
        edtemail = findViewById(R.id.phonr);
        edtpass = findViewById(R.id.password);
        edtcnfpass = findViewById(R.id.cfp);
        edtnumber = findViewById(R.id.refer);
      ...
      //  edtname.addTextChangedListener(nameWatcher);
        ...
        Button cirLoginButton=findViewById(R.id.main_button);
        cirLoginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               // Toast.makeText(NewRegistration.this, "gfgh", Toast.LENGTH_SHORT).show();
                if (TextUtils.isEmpty(emailaddress.getText().toString())||TextUtils.isEmpty(edtpass.getText().toString()) || TextUtils.isEmpty(edtcnfpass.getText().toString())
                    ...
                    builder.setTitle("Conformation")
                            .setTitle("Are you want to registeration on this apps ?")
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            firebaseFirestore.collection("BlockList")
                                    .document(edtemail.getText().toString().toLowerCase() + "@gmail.com")
                                    .get()
                                        ...
                                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                            if (task.isSuccessful()) {
                                                if (task.getResult().exists()) {
                                                  ...
                                                  //Toast.makeText(NewRegistration.this, "1", Toast.LENGTH_SHORT).show();
                                                            ...
                                                            .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                                    if (task.isSuccessful()) {
                                                                        if (task.getResult().exists()) {
                                                                            progressDialog.dismiss();
                                                                            Toasty.error(getApplicationContext(), "This user already taken..", Toast.LENGTH_SHORT, true).show();
                                                                            return;
                                                                        }
                                                                        else {
                                                                          //  Toast.makeText(NewRegistration.this, "2", Toast.LENGTH_SHORT).show();
                                                                            final EditText input = new EditText(NewRegistration.this);
                                                                            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                                                                                    LinearLayout.LayoutParams.MATCH_PARENT,
                                                                                    LinearLayout.LayoutParams.MATCH_PARENT);
                                                                            input.setLayoutParams(lp);
                                                                           // input.setText(edtnumber.getText().toString());
                                                                            input.setHint("Enter Refferal Name");
                                                                            input.setText("amia");

                                                                           // Toast.makeText(NewRegistration.this, "3", Toast.LENGTH_SHORT).show();
                                                                            mAuth.createUserWithEmailAndPassword(edtemail.getText().toString().toLowerCase() + "@gmail.com", "123456")
                                                                                            ...
                                                                                            if (task.isSuccessful()) {
                                                                                                ...
                                                                                                firebaseFirestore.collection("Name_Exsiting")
                                                                                                        ...
                                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                            ...
                                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                                                if (task.isSuccessful()) {
                                                                                                                    old_user(username.getText().toString().toLowerCase().toString());
                                                                                                                    ...
                                                                                                                    mobile=edtemail.getText().toString();
                                                                                                                    Long tsLong = System.currentTimeMillis()/1000;
                                                                                                                    String ts = tsLong.toString();
                                                                                                                    ...
                                                                                                                    storeToFirestore1(name, mobile,image22, firebaseAuth.getCurrentUser().getEmail());
    ...
    private void storeToFirestore1(final String name, final String toString, String image22, final String email) {
        ...
        userMap.put("number", edtemail.getText().toString());
        userMap.put("email",emailaddress.getText().toString().toLowerCase());
        ...
        firebaseFirestore.collection("Users").document(firebaseAuth.getCurrentUser().getUid()).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful())
                {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            firebaseFirestore.collection("Users").document(firebaseAuth.getCurrentUser().getUid())
                                                                    .collection("MainCoin")
                                                                    .document(mAuth.getCurrentUser().getEmail().toLowerCase().toString())
                                                                    .set(mainCoin)
                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                        @Override
                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                        ...
                                                                                                                                        if (task.isSuccessful()) {
                                                                                                                                            ...
                                                                                                                                            handler.postDelayed(new Runnable() {
                                                                                                                                                ...
                                                                                                                                                public void run() {
                                                                                                                                                    ...
                                                                                                                                                    Intent loginSuccess = new Intent(NewRegistration.this,NewLogin.class);
                    ...
                    Toast.makeText(NewRegistration.this,"FIRESTORE Error : "+errorMessage,Toast.LENGTH_LONG).show();
    ...
    private void old_user(String toString) {
        ...
        firebaseFirestore.collection("Old_User")
                .document(toString.toLowerCase().toString())
                .set(userMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    userMap2.put("purches_balance","1");
