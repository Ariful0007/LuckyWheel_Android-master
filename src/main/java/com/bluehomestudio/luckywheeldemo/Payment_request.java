...
public class Payment_request {
    String useremail,paymentmethode,paymentnumber,ammount,date,status,uuid,username,time;
    ...
    public Payment_request(String useremail, String paymentmethode,
                           String paymentnumber, String ammount, String date,
                           String status, String uuid, String username, String time) {
        this.useremail = useremail;
        this.paymentmethode = paymentmethode;
        this.paymentnumber = paymentnumber;
        this.ammount = ammount;
