...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session =new UserSession(RegistrationActivity.this);
        firebaseAuth = FirebaseAuth.getInstance();
        new CheckInternetConnection(this).checkConnection();
        progressDialog=KProgressHUD.create(RegistrationActivity.this);
        ...
        CircularProgressButton cirLoginButton=findViewById(R.id.cirRegisterButton);
        cirLoginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               // Toast.makeText(RegistrationActivity.this, "gfgh", Toast.LENGTH_SHORT).show();
                                                                            ...
                                                                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                                ...
                                                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                                                    ...
                                                                                    if (TextUtils.isEmpty(input.getText().toString())) {
                                                                                        ...
                                                                                        firebaseFirestore.collection("Radmon")
                                                                                                                                            ...
                                                                                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                                                ...
                                                                                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                                    if (task.isSuccessful()) {
                                                                                                                                                        ...
                                                                                                                                                        Long tsLong = System.currentTimeMillis()/1000;
                                                                                                                                                        String ts = tsLong.toString();
                                                                                                                                                        refer_detector(input.getText().toString().toLowerCase().toString(),
                                                                                                                                                                input.getText().toString().toLowerCase().toString()+"@gmail.com",
                                                                                                                                                                firebaseAuth.getCurrentUser().getUid(),username.getText().toString().toLowerCase().toString(),
                                                                                                                                                                UUID.randomUUID().toString(),firebaseAuth.getCurrentUser().getEmail(),ts
                                                                                                                                                        );
    ...
    int count;
    private void refer_detector(String refername, String refername_email,
                                String user_id, String user_name,
                                String uuid, String user_email, String time) {
        Long tsLong = System.currentTimeMillis()/1000;
        String ts = tsLong.toString();
        getcurrentTime();

        Refdferal_model refdferal_model = new Refdferal_model(refername,refername_email,
                user_id,user_name,uuid,user_email,time);
        firebaseFirestore.collection("Persions")
                .document(refername_email)
                .collection("List")
                .document(uuid)
                .set(refdferal_model)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
    ...
    private void getcurrentTime() {
        ...
        userMap.put("time1",current);
        userMap.put("time2",current1);
        getReferusername();
        firebaseFirestore.collection("Dates")
                .document(firebaseAuth.getCurrentUser().getEmail())
                .set(userMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
    ...
    private void getReferusername() {
        Random r = new Random();
        int randomNumber = r.nextInt(99999);
        final Map<String, String> userMap = new HashMap<>();
        userMap.put("username",""+randomNumber);
        firebaseFirestore.collection("Radmon")
    ...
    private void storeToFirestore1(final String name, final String toString, String image22, final String email) {
        ...
        firebaseFirestore.collection("TodayRegister")
                .document(""+year)
                .collection(""+month)
                .document(""+day)
                .collection("List")
        ...
        firebaseFirestore.collection("Users").document(firebaseAuth.getCurrentUser().getUid()).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful())
                {
                                                                                                                                        ...
                                                                                                                                        if (task.isSuccessful()) {
                                                                                                                                            ...
                                                                                                                                            handler.postDelayed(new Runnable() {
                                                                                                                                                ...
                                                                                                                                                public void run() {
                                                                                                                                                    ...
                                                                                                                                                    Intent loginSuccess = new Intent(RegistrationActivity.this,LoginActivity.class);
                    ...
                    Toast.makeText(RegistrationActivity.this,"FIRESTORE Error : "+errorMessage,Toast.LENGTH_LONG).show();
